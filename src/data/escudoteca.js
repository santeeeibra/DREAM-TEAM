...
export const ESCUDOTECA = {
  ...
  'Platense':             `${APISPORTS}/451.png`,
  'Tigre':                `${APISPORTS}/458.png`,

  // ── MLS ──
  // Paladar Negro tiene los escudos actuales de la MLS.
  'Inter Miami CF':       `${PALADAR}/estadosunidos/mls/png/intermiami.png`,
  'LA Galaxy':            `${PALADAR}/estadosunidos/mls/png/lagalaxy.png`,
  'LAFC':                 `${PALADAR}/estadosunidos/mls/png/losangelesfc.png`,
  'Seattle Sounders FC':  `${PALADAR}/estadosunidos/mls/png/seattlesounders.png`,
  'Portland Timbers':     `${PALADAR}/estadosunidos/mls/png/portlandtimbers.png`,
  'Atlanta United FC':    `${PALADAR}/estadosunidos/mls/png/atlantaunited.png`,
  'New York City FC':     `${PALADAR}/estadosunidos/mls/png/newyorkcity.png`,
  'New York Red Bulls':   `${PALADAR}/estadosunidos/mls/png/newyorkredbulls.png`,
  'New England Revolution': `${PALADAR}/estadosunidos/mls/png/newenglandrevolution.png`,
  'Philadelphia Union':   `${PALADAR}/estadosunidos/mls/png/philadelphiaunion.png`,
  'FC Dallas':            `${PALADAR}/estadosunidos/mls/png/fcdallas.png`,
  'Columbus Crew':        `${PALADAR}/estadosunidos/mls/png/columbuscrew.png`,
  'Houston Dynamo FC':    `${PALADAR}/estadosunidos/mls/png/houstondynamo.png`,
  'Sporting Kansas City': `${PALADAR}/estadosunidos/mls/png/sportingkansascity.png`,
  'Colorado Rapids':      `${PALADAR}/estadosunidos/mls/png/coloradorapids.png`,
  'D.C. United':          `${PALADAR}/estadosunidos/mls/png/dcunited.png`,
  'Toronto FC':           `${PALADAR}/estadosunidos/mls/png/torontofc.png`,
  'Vancouver Whitecaps FC': `${PALADAR}/estadosunidos/mls/png/vancouverwhitecaps.png`,
  'Real Salt Lake':       `${PALADAR}/estadosunidos/mls/png/realsaltlake.png`,
  'Chicago Fire FC':      `${PALADAR}/estadosunidos/mls/png/chicagofire.png`,
  'Minnesota United FC':  `${PALADAR}/estadosunidos/mls/png/minnesotaunited.png`,
  'Austin FC':            `${PALADAR}/estadosunidos/mls/png/austinfc.png`,
  'Nashville SC':         `${PALADAR}/estadosunidos/mls/png/nashvillesc.png`,
  'Charlotte FC':         `${PALADAR}/estadosunidos/mls/png/charlottefc.png`,
  'CF Montréal':          `${PALADAR}/estadosunidos/mls/png/cfmontreal.png`,
  'Orlando City SC':      `${PALADAR}/estadosunidos/mls/png/orlandocity.png`,
  'FC Cincinnati':        `${PALADAR}/estadosunidos/mls/png/fccincinnati.png`,
  'San Jose Earthquakes': `${PALADAR}/estadosunidos/mls/png/sanjoseearthquakes.png`,
  'St. Louis City SC':    `${PALADAR}/estadosunidos/mls/png/stlouiscity.png`,
  'San Diego FC':         `${PALADAR}/estadosunidos/mls/png/sandiegofc.png`,
