...
export const leagues = [
  ...
  // Formato especial: 30 equipos en 2 zonas, fase regular de 16 fechas + play-offs
  {
    ...
    clubs: [
      // Zona A (15 equipos)
      { id: 'boca', name: 'Boca Juniors', zona: 'A' },
      ...
      { id: 'velez', name: 'Vélez Sarsfield', zona: 'A' },
      { id: 'estudiantes', name: 'Estudiantes LP', zona: 'A' },
      { id: 'lanus', name: 'Lanús', zona: 'A' },
      { id: 'newells', name: "Newell's", zona: 'A' },
      { id: 'defensa', name: 'Defensa y Justicia', zona: 'A' },
      { id: 'central-cordoba', name: 'Central Córdoba (Santiago del Estero)', zona: 'A' },
      { id: 'union', name: 'Unión', zona: 'A' },
      { id: 'platense', name: 'Platense', zona: 'A' },
      { id: 'deportivo-riestra', name: 'Deportivo Riestra', zona: 'A' },
      { id: 'gimnasia-mendoza', name: 'Gimnasia y Esgrima (Mendoza)', zona: 'A' },
      // Zona B (15 equipos)
      { id: 'river', name: 'River Plate', zona: 'B' },
      { id: 'racing', name: 'Racing Club', zona: 'B' },
      { id: 'huracan', name: 'Huracán', zona: 'B' },
      { id: 'rosario-central', name: 'Rosario Central', zona: 'B' },
      { id: 'belgrano', name: 'Belgrano', zona: 'B' },
      { id: 'argentinos', name: 'Argentinos Juniors', zona: 'B' },
      { id: 'gimnasia', name: 'Gimnasia y Esgrima La Plata', zona: 'B' },
      { id: 'banfield', name: 'Banfield', zona: 'B' },
      { id: 'tigre', name: 'Tigre', zona: 'B' },
      { id: 'atletico-tucuman', name: 'Atlético Tucumán', zona: 'B' },
      { id: 'sarmiento', name: 'Sarmiento', zona: 'B' },
      { id: 'barracas', name: 'Barracas Central', zona: 'B' },
      { id: 'aldosivi', name: 'Aldosivi', zona: 'B' },
      { id: 'estudiantes-rc', name: 'Estudiantes (Río Cuarto)', zona: 'B' },
