...
- Última sesión (2026-08-11): **Fase 2 del draft inicial real**. El onboarding
  ...
  **5 sobres × 5 cartas de la liga elegida** vía `openInitialPacks()`
  ...
  verde: 25 cartas por draft, 8 temporadas completas. Sin bloqueantes técnicos.
...
1. Prueba en navegador contra Supabase real (el smoke usa stubs, no la BD):
   crear DT en cada liga → abrir los 5 sobres de esa liga → armar 11 →
   simular un tramo.
