---
name: dream-team-events
description: "Activa solo cuando la tarea toque narrador.js, api/evento.js, el catálogo de eventos o los prompts a GROQ en este repo. Define el flujo orquestador → IA → validación estricta con fallback silencioso, las reglas de contenido de eventos narrativos y los guardrails en código que la IA no puede eludir."
---
