...
- **Loop**: crear DT en una de 3 ligas → draft inicial de tu liga (3 sobres × 5 cartas, `openInitialPacks`) → armar 11 → temporada por tramos → resumen → sobre de refuerzo (`open-pack`) → siguiente temporada (8 por carrera).
